...
const { EnObject, EnPronouns, EsObject, EsPronouns, UniSbGiveSbSth } = generate4
...
suite('generate4', function() {
  test('testEnglish', function() {
    ...
    const story = new UniSbGiveSbSth('Dan', 'Dan', 'Robot')
  ...
  test('testSpanish', function() {
    ...
    // Ellos me los dan.
    const vp = new UniSbGiveSbSth('Friend', 'Dan', 'Gifts').toEs(objects)
